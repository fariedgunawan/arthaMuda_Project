  ...
  return (
    ...
    <ImageBackground source={require("../assets/bg-img.png")} className="min-h-screen">
      ...
      <View className="container flex justify-center items-center min-h-screen">
        <Text className="font-bold text-[30px] text-[#3339B4]">Create Your Account</Text>
        ...
        <View className="flex flex-row items-center bg-transparent px-[10px] rounded-2xl mt-[20px] border-2 border-[#3339B4]">
          ...
          <TextInput placeholder="Password..." placeholderTextColor="#3339B4" className="bg-transparent rounded-xl w-[200px] h-[40px] px-[10px]" />
        </View>

        <TouchableOpacity className="mt-[20px]" onPress={() => navigation.navigate("Login")}>
          <Text className="bg-[#3339B4] py-[10px] text-center text-white font-semibold rounded-2xl w-[240px]">Register</Text>
        </TouchableOpacity>

        <View className="flex flex-row items-center mt-[7px]">
          <Text className="text-[#3339B4] font-light">Have an account ?</Text>
          <TouchableOpacity onPress={() => navigation.navigate("Login")}>
            <Text className="ml-[5px] font-bold text-[#3339B4]">Login</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
